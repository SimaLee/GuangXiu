...
public class PergolaPresenter extends BasePresenter<TechniqueContract.PergolaView> implements TechniqueContract.IPergolaPresenter {
    ...
    private PergolaIntroduction testMultiItemContainer() {
        ...
        item2.setText("\t\t这是第二个TextGX/\t\t宋建隆二年（961 年），朝廷诏令各地种桑养蚕，发展丝织业。广绣开始从深闺小院和皇室内庭走向市场，发展为一项重要的民间副业。由于宋仁宗嘉佑年间（1056-1063 年），朝廷派人重修大庾通道，极大地改善了这条通道的交通状况，使外省的丝绸产品源源不断流入广东。这为广绣吸纳外来绣种的工艺和技法提供了可能，也使广绣受到北绣欣赏品的影响，欣赏品的工艺日臻成熟。 " +
